...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?php echo $url?>/admin" class="brand-link">
      <img src="<?php echo $url;?>/public/img/logo_cb.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">Cafe Biblioteca</span>
    </a>
